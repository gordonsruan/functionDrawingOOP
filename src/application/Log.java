...
public class Log extends Function implements Calculations, Drawable{
	protected double a;
	protected double b;
	protected double x1;
	
	public Log(double x1, double x2, double a, double b, double xshift) {
		super(x1, x2);
		this.a = a;
		this.b = b; 
		this.x1 = xshift;
	...
	public double val(double x) {
		...
		double y  = this.a* Math.log(x-x1) + this.b;
		return y;
	}
...
@Override
	...
	public void draw(GraphicsContext gc, Function f) {
		// TODO Auto-generated method stubpublic void draw(GraphicsContext gc, Function f)
